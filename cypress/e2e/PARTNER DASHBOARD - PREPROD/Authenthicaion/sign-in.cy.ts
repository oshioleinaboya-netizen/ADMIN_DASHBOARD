import { partnerLinkPD, partnerEmailPD, partnerPasswordPD } from "cypress/support/env";
import { faker } from "@faker-js/faker";

describe('Input validations', () => {
    beforeEach(() => {
        cy.visit(partnerLinkPD);
    })
    ...
    it('Admin log in - Clear out state tests', () => {
        ...
        const cases = [
        { email: "hshshhshs90@heyoni.com", password: partnerPasswordPD, clear: 'text', expectedError: ['Please enter a valid email address', 'Please enter your password'] },
        ]
...
describe('Sign in', () => {
    ...
    it('Partner log in - Valid credentials', () => {
        ...
        cy.contains('Password').parent().find('input').type(partnerPasswordPD) // password input
        ...
        submitLogin(partnerEmailPD, partnerPasswordPD) // Partner Sign in
